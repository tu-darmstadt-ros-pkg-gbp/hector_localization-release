...
The packages in the `hector_localization` repository were released into the `hydro` distro by running `/usr/bin/bloom-release hector_localization -r hydro -t hydro` on `Mon, 02 Jun 2014 10:26:47 -0000`
